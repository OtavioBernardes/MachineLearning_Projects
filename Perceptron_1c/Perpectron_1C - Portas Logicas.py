...
Conseguimos aplicar esse algortimo nas portas AND e OR, pois são linearmente separaveis.

Para aplicarmos em uma porta XOR, precisaremos de uma rede multicamadas.
"""
...
# saidas = np.array([0,1,1,1]) # Podemos tambem usar uma porta OR
